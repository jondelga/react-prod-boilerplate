 ...
 * @param  {Promise} dataPromise Promise that loads data from an external
 * source (e.g. OrderService.getOrders())
...
const _getRandomDelayBetween = (min, max, roundTo) => {
