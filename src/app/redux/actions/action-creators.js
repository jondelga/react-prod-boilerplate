...
export const makeActionCreator = (type, ...keys) => {
  if (!type) throw new Error('Type cannot be null/undefined'); // eslint-disable-line
...
export const makeEntityActionCreator = (type, entity, ...keys) => {
  if (!type) throw new Error('Type cannot be null/undefined'); // eslint-disable-line
  if (!entity) throw new Error('Entity cannot be null/undefined'); // eslint-disable-line
  return function (...args) {
